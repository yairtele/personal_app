...
class MoviePart1 extends StatefulWidget{
  const MoviePart1({Key? key}) : super(key: key);

  @override
  _MoviePart1State createState() => _MoviePart1State();
}

class _MoviePart1State extends State<MoviePart1> {
  ...
  Future<String> _loadText(void _) async {
    ...
    return rootBundle.loadString('assets/texts/movie_part1.txt');
  }
